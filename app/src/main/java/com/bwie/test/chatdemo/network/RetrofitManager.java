package com.bwie.test.chatdemo.network;



import com.bwie.test.chatdemo.MyApplication;
import com.bwie.test.chatdemo.network.cookie.CookiesManager;
...
public class RetrofitManager {
    ...
    private static OkHttpClient okHttpClient = new OkHttpClient.Builder()
            .cookieJar(new CookiesManager(MyApplication.application))
